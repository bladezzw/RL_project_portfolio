...
def sac_discrete(env_fn, Actor=core.DiscreteMLPActor, Critic=core.DiscreteMLPQFunction, ac_kwargs=dict(), seed=0,
        ...
        polyak=0.995, lr=0.0003, alpha=0.2, batch_size=100, start_steps=1000,
        update_after=1000, update_times_every_step=50, num_test_episodes=10, max_ep_len=1000,
        logger_kwargs=dict(), save_freq=1, automatic_entropy_tuning=True, use_gpu=False,
        gpu_parallel=False, total_eps=100):
    """
    ...
    while eps < total_eps:
        ...
        #     logger.log_tabular('EpLen', average_only=False)
        #     logger.log_tabular('TestEpLen', average_only=False)
